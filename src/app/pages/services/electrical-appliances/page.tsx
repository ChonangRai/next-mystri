  ...
  const videos: MediaItem[] = [
    {
      ...
      title: "Timelapse Electrical Applaince Repairs",
      description: "Watch a full room transformation in just minutes.",
      url: "/videos/electrical.mp4", // This is used in the iframe src
    },
      ...
      try {
        ...
        const pdCategory = data.find(
          (category: { category: string }) =>
            category.category.toLowerCase() === "electrical appliances and electricity"
        );
