...
export default function GardeningLandscaping() {
      ...
      try {
        ...
        const pdCategory = data.find(
          (category: { category: string }) =>
            category.category.toLowerCase() === "gardening and landscaping"
        );
