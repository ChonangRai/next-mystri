...
export default function PaintingDecoration() {
  ...
  const videos: MediaItem[] = [
    {
      type: "video",
      src: "/videos/painting_dec.mp4",
      title: "Timelapse Painting Project",
      description: "Watch a full room transformation in just minutes.",
      url: "/videos/painting_dec.mp4", // This is used in the iframe src
    },
      ...
      try {
        ...
        const pdCategory = data.find(
          (category: { category: string }) =>
            category.category.toLowerCase() === "painting and decoration"
        );
