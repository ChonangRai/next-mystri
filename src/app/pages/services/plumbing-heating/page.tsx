...
export default function PlumbingHeating() {
  ...
  const videos: MediaItem[] = [
    {
      ...
      title: "Timelapse Plumbing Project",
      description: "Watch a full room transformation in just minutes.",
      url: "/videos/plumber.mp4", // This is used in the iframe src
    },
      ...
      try {
        ...
        const pdCategory = data.find(
          (category: { category: string }) =>
            category.category.toLowerCase() === "plumbing and heating"
        );
